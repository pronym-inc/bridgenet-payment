...
ROOT_URLCONF = 'bridgenet_payment.conf.urls.main'
...
WSGI_APPLICATION = 'bridgenet_payment.conf.wsgi.app.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': secrets.get('db_name', 'bridgenet_payment'),
        'USER': secrets.get('db_username', 'bridgenet_payment'),
...
# Logging
LOG_PATH = os.path.join(VIRTUALENV_DIR, 'var/log/django/bridgenet_payment.log')
